                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary mt-3">LOGIN USER </h3>
                                        <?php if(isset($_GET["pesan"])):
                                            if($_GET["pesan"] == "passwordatauemailsalah"): ?>
                                        <div class="alert alert-danger bg-danger text-white m-t-30" role="alert">
                                            Email / Password Salah
                                            <small class="float-right text-info"><a href="loginn.php"
                                                    class="text-info">Close</a></small>
                                        </div>
                                        <?php
                                            endif;
                                        endif; ?>
                                        ...
                                        <div class="alert alert-success bg-success text-white m-t-30" role="alert">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        ...
                                        <div class="forgot-phone text-center">
                                            <span class="small"> Belum Punya Akun ?</span> <a href="signup.php"
